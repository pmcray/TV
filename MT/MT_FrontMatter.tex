...
On Self-Referential Sentences                   3
...
On Self-Referential Sentences                                                               4
...
On Self-Referential Sentences                                                             5
...
many suspect it.
                                        ...
                                        *     *    *
        In his July, 1979 column, Martin wrote a very warm review of my book Gödel,
...
On Self-Referential Sentences                                                              6
...
liar paradox, namely, "This formula is unprovable within axiomatic system S. "
        In actuality, the Gödel construction yields a mathematical formula, not an English
...
On Self-Referential Sentences                                                            7
...
leave it at that.
         But let us undigress and return to the Gödelian formula and focus on its meaning.
...
paradox -a statement both true and false-and would come tumbling down.
         Gödel’s statement, on the other hand, is not paradoxical, though it constitutes a
hair-raisingly close approach to paradox. It turns out to be true, and for this reason, it is
unprovable in the given axiomatic system. The revelation of Gödel’s work is that in any
...
rather sparse formal language Gödel was employing. Quine's construction yields a new
way of expressing the liar paradox. It is this:




On Self-Referential Sentences                                                              8
...
On Self-Referential Sentences                                                               9
...
examples of self-referential use-mention play:
   ...
   "`No, I have decided to change my mind; when the triple quotes close, just skip
...
The bilingual example may be more effective if you know only one of the\_ two
languages involved.
...
of the sentence but about the sentence itself?
                                      ...
                                      *       *       *
Many simplified treatments of Gödel’s work give as the English translation of his famous
...
On Self-Referential Sentences                                                              10
...
On Self-Referential Sentences                                                                11
...
On Self-Referential Sentences                                                             12
...
On Self-Referential Sentences                                                          13
...
where π actually did have the value 3, you wouldn't ask about how things would be if it
were 3. Instead, you might muse "if π were 2" or "if π weren't 3". So one's first answer to
the question might be this: "What would this sentence be like if π weren't 3?". But there
...
even more serious problem with it than so far mentioned. Changing the value of π is, to
...
any sense if π were 3 (including the concepts of "π", "3", and so on).
...
On Self-Referential Sentences                                                               14
...
On Self-Referential Sentences                                                               15
...
On Self-Referential Sentences                                                              16
...
On Self-Referential Sentences                                                               17
...
On Self-Referential Sentences                                                              18
...
On Self-Referential Sentences                                                              19
...
On Self-Referential Sentences                                                                  20
...
fluently.
   ...
   5. The subject of Sentence M is a pointer to an individual named `Mary', the predicate
...
On Self-Referential Sentences                                                               21
...
On Self-Referential Sentences                                                            22

In other words, Case translates a self-referential French sentence into an other- referential
...
On Self-Referential Sentences                                                             23
